...
```bash
python3 global_ci_activation/scripts/plot_global_ci_activation.py
```
...
- `output/global_ci_activation_map.png`
- `output/global_ci_activation_map.pdf`
- `output/global_ci_activation_map.tif`
- `output/city_ci_activation_summary.csv`
