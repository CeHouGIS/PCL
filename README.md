...
## Historical direct-tie validation

A raw-data-free publication figure and aggregate results comparing verified direct historical ties with CI are available in [`historical_ties_validation/`](historical_ties_validation/README.md).
