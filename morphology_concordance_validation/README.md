...
```bash
python3 morphology_concordance_validation/scripts/calculate_morphology_concordance.py
python3 morphology_concordance_validation/scripts/plot_morphology_concordance.py
```
